...
//   useEffect(() => {
//     // Recupera legaId dell'utente loggato
...
//                       .slice(0, 5) // Modifica per mostrare tutto o solo top 5!
//                       .map((entry, i) => (
...
//                 </table>
//               ) : (
//                 <div className="text-muted">Nessuna squadra in classifica</div>
//               )}
//             </Card.Body>
//           </Card>
//         </Col>
