...
const classificaPiloti = {
  piloti: [
    ...
    { nome: "Max Verstappen", punti: 341 },
    { nome: "George Russell", punti: 276 },
    { nome: "Charles Leclerc", punti: 214 },
    { nome: "Lewis Hamilton", punti: 148 },
    { nome: "Andrea Kimi Antonelli", punti: 122 },
    { nome: "Alexander Albon", punti: 73 },
    { nome: "Nico Hulkenberg", punti: 43 },
    { nome: "Isack Hadjar", punti: 43 },
    { nome: "Fernando Alonso", punti: 40 },
    { nome: "Oliver Bearman", punti: 40 },
    { nome: "Carlos Sainz", punti: 38 },
    { nome: "Liam Lawson", punti: 36 },
    { nome: "Lance Stroll", punti: 32 },
    { nome: "Esteban Ocon", punti: 30 },
